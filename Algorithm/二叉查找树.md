...
[二叉查找树](#二叉查找树)   
&emsp;[1. 介绍](#1-介绍)   
&emsp;[2. 数据结构的实现](#2-数据结构的实现)   
&emsp;[3. API 实现](#3-api-实现)   
&emsp;&emsp;[3.1 搜索](#31-搜索)   
&emsp;&emsp;[3.2 插入](#32-插入)   
&emsp;&emsp;[3.3 删除](#33-删除)   
&emsp;&emsp;&emsp;[3.3.1 删除 最小/最大 值](#331-删除-最小最大-值)   
&emsp;&emsp;&emsp;[3.3.2 通常节点的删除](#332-通常节点的删除)   
&emsp;&emsp;[3.4 其他的有序方法](#34-其他的有序方法)   
&emsp;&emsp;&emsp;[3.4.1 最小和最大](#341-最小和最大)   
&emsp;&emsp;&emsp;[3.4.2 向下取整/向上取整](#342-向下取整向上取整)   
&emsp;&emsp;&emsp;[3.4.3 选择和排序](#343-选择和排序)   
&emsp;&emsp;&emsp;[3.4.4 范围](#344-范围)   
&emsp;[4. 性能](#4-性能)   
&emsp;[5. 结论](#5-结论)   
