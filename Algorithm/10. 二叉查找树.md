...
[10. 二叉查找树](#10-二叉查找树)  
&emsp;[10.1 实现](#101-实现)  
&emsp;&emsp;[10.1.1 数据形式的实现](#1011-数据形式的实现)  
&emsp;&emsp;[10.1.2 搜索](#1012-搜索)  
&emsp;&emsp;[10.1.3 插入](#1013-插入)  
&emsp;&emsp;[10.1.4 删除](#1014-删除)  
&emsp;&emsp;&emsp;[10.1.4.1 删除 最小/最大 值](#10141-删除-最小最大-值)  
&emsp;&emsp;&emsp;[10.1.4.2 通常节点的删除](#10142-通常节点的删除)  
&emsp;&emsp;[10.1.5 其他的有序方法](#1015-其他的有序方法)  
&emsp;&emsp;&emsp;[10.1.5.1 最小和最大](#10151-最小和最大)  
&emsp;&emsp;&emsp;[10.1.5.2 向下取整/向上取整](#10152-向下取整向上取整)  
&emsp;&emsp;&emsp;[10.1.5.3 选择和排序](#10153-选择和排序)  
&emsp;&emsp;&emsp;[10.1.5.4 范围](#10154-范围)  
&emsp;[10.2 性能](#102-性能)  
&emsp;[10.3 结论](#103-结论)  
...
为了解决上述问题和需求，同时提高插入和删除的效率；
我们可以使用**二叉查找树**来进行优化。

二叉查找树是一种**树**，它满足：

1. 每个节点都拥有一个 **Conparable** 键
...
在一个有 $N$ 个随机键值的二叉树中，插入和未命中搜索需要 $\sim 2lnN$ (大约是 $1.39lgN$) 次的比较
