...
[4. 基本排序算法](#4-基本排序算法)  
&emsp;[4.1 选择排序](#41-选择排序)  
&emsp;&emsp;[4.1.1 性能](#411-性能)  
&emsp;[4.2 插入排序](#42-插入排序)  
&emsp;&emsp;[4.2.1 实现](#421-实现)  
&emsp;&emsp;[4.2.2 性能](#422-性能)  
&emsp;&emsp;[4.2.3 优化](#423-优化)  
&emsp;&emsp;&emsp;[4.2.3.1 使用移动代替交换](#4231-使用移动代替交换)  
&emsp;&emsp;&emsp;[4.2.3.1 使用二分查找](#4231-使用二分查找)  
&emsp;[4.3 希尔排序](#43-希尔排序)  
&emsp;&emsp;[4.3.1 实现](#431-实现)  
&emsp;&emsp;[4.3.2 性能](#432-性能)  
