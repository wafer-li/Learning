...
[6. 快速排序](#6-快速排序)  
&emsp;[6.0 介绍](#60-介绍)  
&emsp;[6.1 基本实现](#61-基本实现)  
&emsp;[6.2 切分](#62-切分)  
&emsp;&emsp;[6.2.1 实现](#621-实现)  
&emsp;&emsp;[6.2.2 注意事项](#622-注意事项)  
&emsp;[6.3 性能](#63-性能)  
&emsp;[6.4 改进](#64-改进)  
&emsp;&emsp;[6.4.1 切换到插入排序](#641-切换到插入排序)  
&emsp;&emsp;[6.4.2 三取样切分](#642-三取样切分)  
&emsp;&emsp;[6.4.3 三向切分的快速排序](#643-三向切分的快速排序)  
&emsp;&emsp;&emsp;[6.4.3.1 实现](#6431-实现)  
&emsp;&emsp;&emsp;[6.3.2 性能](#632-性能)  
